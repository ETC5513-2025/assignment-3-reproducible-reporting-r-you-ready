...
---
## Background Test
<!-- .slide: data-background-color="#880000" -->

If this slide has a dark red background, `.slide:` is working.

------------------------------------------------------------------------

## Does Income Deprivation Affect Educational Attainment?
<!-- .slide: data-background-image="../images/open_page.JPG" data-background-size="cover" -->
...
## Introduction
<!-- .slide: data-background-image="../images/main_page.JPG" data-background-size="cover" -->
